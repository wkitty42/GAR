...
<TABLE WIDTH='100%'>
    <TR>
	<TD WIDTH='25%' CLASS='base' ALIGN='LEFT'>$tr{'enabled'}&nbsp;&nbsp;<INPUT TYPE='checkbox' NAME='ENABLE_GUARD' $checked{'ENABLE_GUARD'}{'on'}><INPUT TYPE='hidden' NAME='GUARD_STATE' VALUE='$GAR_Settings{'GUARD_STATE'}'></TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='CENTER'>Guardian ${guard_ver}</TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='CENTER'>Snort ${SnortDisplayVersion}</TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='RIGHT'><INPUT TYPE='submit' NAME='ACTION' VALUE='$tr{'save'}'></TD>
    </TR>
    <TR>
	<TD WIDTH='25%' CLASS='base' ALIGN='LEFT'><A HREF='/mods/GAR/snortstats'><FONT COLOR='blue'>$tr{'garsnortstats link'}</FONT></A></TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='CENTER'>&nbsp;</TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='CENTER'>&nbsp;</TD>
	<TD WIDTH='25%' CLASS='base' ALIGN='RIGHT'><A HREF='gartool.cgi'><FONT COLOR='blue'>$tr{'gartool link'}</FONT></A></TD>
    </TR>
</TABLE>
END
