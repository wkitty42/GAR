...
<TABLE WIDTH='100%'>
    <TR>
	<TD WIDTH='25%' CLASS='base' ALIGN='LEFT'><A HREF='/cgi-bin/mods/GAR/gar.cgi'><FONT COLOR='blue'>$tr{'garcfg link'}</FONT></A></TD>
	...
	<TD WIDTH='25%' CLASS='base' ALIGN='RIGHT'><A HREF='/cgi-bin/mods/GAR/gartool.cgi'><FONT COLOR='blue'>$tr{'gartool link'}</FONT></A></TD>
    </TR>
</TABLE>
END
